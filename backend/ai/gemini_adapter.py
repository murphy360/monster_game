        ...
        try:
            ...
            for attempt in range(1, self.BACKGROUND_MAX_RETRIES + 1):
                ...
                prompt = (
                    ...
                    "Immediately inside that outer border, draw a continuous 2-pixel pure black (#000000) rectangle on all four sides. "
                    "The chosen mask color border must be completely OUTSIDE this black rectangle, and there must be zero chosen-color pixels on the inside (scene side) of the black rectangle. "
